...
transactions_data = pd.read_csv("fyp_ponzi_detection-main\cleaned_internal_transactions.csv")
...
columns_to_drop = ["hash", "from", "to", "input", "contractAddress", "ponzi_name", "Date"]
